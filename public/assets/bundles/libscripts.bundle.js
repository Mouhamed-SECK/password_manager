!(function (e, t) {
      ...
      if (!i && (x(e), (e = e || E), T)) {
        if (11 !== d && (a = te.exec(t)))
          if ((c = a[1])) {
            ...
            } else if (u && (o = u.getElementById(c)) && v(e, o) && o.id === c)
              return n.push(o), n;
          } else {
        ...
        function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === u.length)) {
            if (
              ...
              if (!(t = (_.find.ID(s.matches[0].replace(ie, d), t) || [])[0]))
                return n;
  ...
  (T.filter = function (e, t, n) {
    ...
    T.fn.extend({
      ...
      is: function (e) {
        return !!D(this, "string" == typeof e && A.test(e) ? T(e) : e || [], !1)
          .length;
      },
    });
  var L = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[r]) {
              if (i.length)
                ...
                (t = o(this, r)),
                this[r](),
                i !== (n = Q.get(this, r)) || t ? Q.set(this, r, !1) : (n = {}),
                i !== n)
              )
                return (
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            ue.test(e.type) && e.click && k(e, "input") && Ee(e, "click", be),
            !1
          );
        },
        trigger: function (e) {
          e = this || e;
          return (
            ue.test(e.type) && e.click && k(e, "input") && Ee(e, "click"), !0
          );
        },
        _default: function (e) {
          e = e.target;
    ...
    if (
      ...
      for (a = (s = T.map(pe(e, "script"), Se)).length; u < d; u++)
        (l = e),
          ...
          r.call(n[u], l, u);
      if (a)
        for (c = s[s.length - 1].ownerDocument, T.map(s, De), u = 0; u < a; u++)
          (l = s[u]),
            fe.test(l.type || "") &&
  ...
  T.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        0 < (s = pe(u, "script")).length && ge(s, !d && pe(e, "script")), u
      );
    },
        ...
        if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              p && ce([e], !0),
              d.done(function () {
                for (i in (p || ce([e]), Q.remove(e, "fxshow"), f))
                  T.style(e, i, f[i]);
              })),
              (l = pt(p ? g[i] : 0, i, d)),
              i in g ||
  ...
  T.ajaxSetup({
    ...
    (T.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === a && (e.style.position = "relative"),
          ...
          null != (t = b(t) ? t.call(e, n, T.extend({}, o)) : t).top &&
            (c.top = t.top - o.top + r),
    ...
    T.each(["top", "left"], function (e, n) {
      T.cssHooks[n] = Ye(y.pixelPosition, function (e, t) {
        if (t)
          return (t = Ve(e, n)), We.test(t) ? T(e).position()[n] + "px" : t;
      });
    }),
  ...
  (function (e, t) {
    ...
    const b = (e) => {
      ...
      _ = (n, i, e = !0) => {
        if (e) {
          ...
          let t = !1;
          const r = ({ target: e }) => {
            e === i && ((t = !0), i.removeEventListener(o, r), b(n));
          };
        ...
        off(n, i, e, t) {
          if ("string" == typeof i && n) {
              ...
              Object.keys(l).forEach((e) => {
                !(function (t, n, i, r) {
                  ...
                  Object.keys(o).forEach((e) => {
                    e.includes(r) &&
                      ((e = o[e]),
                      P(t, n, i, e.originalHandler, e.delegationSelector));
                  });
                })(n, l, e, i.slice(1));
              });
            const c = l[s] || {};
            Object.keys(c).forEach((e) => {
              ...
              (a && !i.includes(t)) ||
                ((e = c[e]),
                P(n, l, s, e.originalHandler, e.delegationSelector));
            });
          }
        },
        trigger(e, t, n) {
        ...
        d.find(".carousel-item img", this._element).forEach((e) => {
          ...
          this._pointerEvent
            ? (M.on(this._element, "pointerdown.bs.carousel", (e) => t(e)),
              M.on(this._element, "pointerup.bs.carousel", (e) => i(e)),
              this._element.classList.add("pointer-event"))
            : (M.on(this._element, "touchstart.bs.carousel", (e) => t(e)),
              M.on(this._element, "touchmove.bs.carousel", (e) => n(e)),
              M.on(this._element, "touchend.bs.carousel", (e) => i(e)));
      }
      _keydown(e) {
        var t;
    ...
    class ve extends W {
      ...
      toggle() {
        this._element.classList.contains(fe) ? this.hide() : this.show();
      }
      show() {
        if (!this._isTransitioning && !this._element.classList.contains(fe)) {
          ...
          if (!M.trigger(this._element, "show.bs.collapse").defaultPrevented) {
            e &&
              e.forEach((e) => {
                i !== e && ve.collapseInterface(e, "hide"), t || $(e, ce, null);
              });
          ...
          if (0 < t)
            for (let e = 0; e < t; e++) {
              ...
              i &&
                ...
                (n.classList.add(ge), n.setAttribute("aria-expanded", !1));
            }
          this.setTransitioning(!0);
          (this._element.style[e] = ""),
            this._queueCallback(
      ...
      _getConfig(e) {
        return (
          ((e = { ...ue, ...e }).toggle = Boolean(e.toggle)), n(le, e, de), e
        );
      }
      _getDimension() {
    ...
    function Ge(e) {
      return "html" === $e(e)
        ? e
        : e.assignedSlot || e.parentNode || (Fe(e) ? e.host : null) || Ke(e);
    }
    function Je(e) {
    ...
    function ut(e) {
        ...
        c =
          !0 === l
            ? ((h = (g = r).x),
              ...
              { x: it(it(h * g) / g) || 0, y: it(it(p * g) / g) || 0 })
            : "function" == typeof l
            ? l(r)
            : r,
        u = c.x,
      ...
      a &&
        ...
        i === ye && ((l = be), (e -= r[c] - n.height), (e *= s ? 1 : -1)),
        i === we && ((g = _e), (d -= r[f] - n.width), (d *= s ? 1 : -1)));
          ...
          return (
            ...
            function () {
              r &&
                ...
                o && s.removeEventListener("resize", n.update, ft);
            }
          );
        },
        data: {},
                ...
                return e.concat(
                  Ue(t) === xe
                    ? ((n = d),
                      ...
                      (a = i.padding),
                      (e = i.flipVariations),
                      (l = void 0 === (i = i.allowedAutoPlacements) ? Oe : i),
                      (c = Ct(r)),
                      (r = c
                        ? e
                          ? Le
                ...
                (r =
                  (r = (n =
                    "function" == typeof r
                      ...
                      : r)[0]) || 0),
                (n = ((n = n[1]) || 0) * t),
                0 <= [we, _e].indexOf(o) ? { x: n, y: r } : { x: r, y: n })),
              e
            );
          }, {}),
          i = (t = e[s.placement]).x,
    ...
    class rn extends W {
      ...
      toggle() {
        f(this._element) ||
          (this._element.classList.contains(Xt) ? this.hide() : this.show());
      }
      show() {
          ...
          if (
            ...
            if (this._inNavbar)
              ...
              (this._popper = $t(e, this._menu, i)),
                t && Y.setDataAttribute(this._menu, "popper", "static");
            }
            "ontouchstart" in document.documentElement &&
      ...
      _getPlacement() {
        ...
        return e.classList.contains("dropup") ? (t ? Kt : Qt) : t ? Jt : Gt;
      }
      _detectNavbar() {
      ...
      static dataApiKeydownHandler(e) {
        if (
          ...
          if (
            ...
            var n = () => (this.matches(Vt) ? this : d.prev(this, Vt)[0]);
            return e.key === Wt
              ? (n().focus(), void rn.clearMenus())
              : e.key === Ft || e.key === zt
              ? (t || n().click(), void rn.getInstance(n())._selectMenuItem(e))
              : void ((t && "Space" !== e.key) || rn.clearMenus());
          }
        }
      }
    }
    ...
    class fn {
      ...
      _getConfig(e) {
        return (
          ((e = { ...ln, ...("object" == typeof e ? e : {}) }).rootElement = u(
            e.rootElement
          )),
          n(un, e, cn),
          e
    ...
    class Cn extends W {
      ...
      show(e) {
        this._isShown ||
          this._isTransitioning ||
          M.trigger(this._element, vn, { relatedTarget: e }).defaultPrevented ||
          ((this._isShown = !0),
    ...
    class Nn extends W {
      ...
      show(e) {
        this._isShown ||
          ...
          this._backdrop.show(),
          this._config.scroll ||
            (new an().hide(), this._enforceFocusOnElement(this._element)),
          this._element.removeAttribute("aria-hidden"),
          this._element.setAttribute("aria-modal", !0),
          this._element.setAttribute("role", "dialog"),
          this._element.classList.add("show"),
          ...
          c.forEach((e) => {
            ((e, t) => {
              ...
              if (t.includes(n))
                return (
                  !jn.has(n) ||
                  Boolean(In.test(e.nodeValue) || Pn.test(e.nodeValue))
                );
    ...
    class Kn extends W {
      ...
      _addAttachmentClass(e) {
        this.getTipElement().classList.add(`${qn}-${this.updateAttachment(e)}`);
      }
      _getAttachment(e) {
      ...
      _enter(e, t) {
        (t = this._initializeOnDelegatedTarget(e, t)),
          e && (t._activeTrigger["focusin" === e.type ? Qn : Yn] = !0),
      ...
      _getConfig(e) {
        ...
        return (
          ...
          e.sanitize &&
            (e.template = Hn(e.template, e.allowList, e.sanitizeFn)),
          e
        );
      }
      _getDelegateConfig() {
    ...
    class ri extends Kn {
      ...
      _addAttachmentClass(e) {
        this.getTipElement().classList.add(`${Gn}-${this.updateAttachment(e)}`);
      }
      _getContent() {
        return (
        ...
        n.classList.contains(ci)
          ...
          : (n.classList.add(ui),
            d.parents(n, ".nav, .list-group").forEach((e) => {
              d.prev(e, `${di}, ${fi}`).forEach((e) => e.classList.add(ui)),
                d.prev(e, ".nav-item").forEach((e) => {
                  d.children(e, di).forEach((e) => e.classList.add(ui));
                });
            })),
