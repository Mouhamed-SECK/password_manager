  ...
  (i.prototype = {
    init: function () {
      ...
      s.reset(),
        ...
        s.el.on("click", "button", function (t) {
          var e;
          s.dragEl ||
            ((t = (e = d(t.currentTarget)).data("action")),
            (e = e.parent(s.options.itemNodeName)),
            "collapse" === t && s.collapseItem(e),
            "expand" === t && s.expandItem(e));
        });
      function t(t) {
        var e = d(t.target);
        ...
        e.length &&
          ...
          (s.isTouch && 1 !== t.touches.length) ||
            (t.preventDefault(), s.dragStart(t.touches ? t.touches[0] : t)));
      }
      function e(t) {
        s.dragEl &&
    ...
    serialize: function () {
      ...
      return (
        ...
        step(a.el.find(a.options.listNodeName).first(), 0)
      );
    },
    serialise: function () {
    ...
    collapseAll: function () {
      var t = this;
      t.el.find(t.options.itemNodeName).each(function () {
        t.collapseItem(d(this));
      });
    },
    setParent: function (t) {
      t.children(this.options.listNodeName).length &&
        (t.prepend(d(this.options.expandBtnHTML)),
        t.prepend(d(this.options.collapseBtnHTML))),
        t.children('[data-action="expand"]').hide();
    },
    ...
    dragStart: function (t) {
      ...
      for (
        ...
        (a = d(o[l]).parents(this.options.listNodeName).length) >
    ...
    dragMove: function (t) {
      ...
      i.dirAx !== a
        ...
        i.dirAx &&
          ...
          ((i.distAxX = 0),
          (n = this.placeEl.prev(s.itemNodeName)),
          0 < i.distX &&
            n.length &&
            !n.hasClass(s.collapsedClass) &&
            ((e = n.find(s.listNodeName).last()),
            this.placeEl.parents(s.listNodeName).length + this.dragDepth <=
              s.maxDepth &&
              (e.length
                ? (e = n.children(s.listNodeName).last()).append(this.placeEl)
                : ((e = d("<" + s.listNodeName + "/>").addClass(
                    s.listClass
                  )).append(this.placeEl),
                  n.append(e),
                  this.setParent(n)))),
      ...
      var o = !1;
      if (
        (p || (this.dragEl[0].style.visibility = "hidden"),
        (this.pointEl = d(
          r.elementFromPoint(
            t.pageX - r.body.scrollLeft,
            t.pageY - (h.pageYOffset || r.documentElement.scrollTop)
          )
        )),
        p || (this.dragEl[0].style.visibility = "visible"),
        ...
        return;
      var l,
        a = this.pointEl.closest("." + s.rootClass),
        n = this.dragRootEl.data("nestable-id") !== a.data("nestable-id");
      (i.dirAx && !n && !o) ||
        (n && s.group !== a.data("nestable-group")) ||
        this.dragDepth - 1 + this.pointEl.parents(s.listNodeName).length >
          s.maxDepth ||
        ((t = t.pageY < this.pointEl.offset().top + this.pointEl.height() / 2),
        (l = this.placeEl.parent()),
        o
          ? ((e = d(r.createElement(s.listNodeName)).addClass(
              s.listClass
            )).append(this.placeEl),
