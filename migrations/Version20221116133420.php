 ...
 */
final class Version20221116133420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE groupe ADD CONSTRAINT FK_4B98C216D1BCE6F FOREIGN KEY (group_admin_id) REFERENCES user (id)');
