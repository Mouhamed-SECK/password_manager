...
class UserController extends AbstractController
{
    ...
    #[
        Route(
            "/users/changeUserTempPassword",
            name: "user.change-user-temp-password"
        )
    ]
    public function changeUserTempPassword(
        Request $request,
        EntityManagerInterface $manager,
    ...
    public function savePasswordLog(
        Request $request,
        EntityManagerInterface $manager
    ): Response {
        $user = $this->get("security.token_storage")
