...
class AdminUserController extends AbstractController
{
    ...
    #[
        Route(
            "/admin/users/createGroupUser",
            name: "admin.users.createGroupUser"
        )
    ]
    public function createGroupUser(
        ...
        $admin = $this->get("security.token_storage")
            ->getToken()
            ->getUser();
    ...
    #[
        Route(
            "/users/change-temporary-password",
            name: "reset_temporary_password"
        )
    ]
